...
export const ProfileDto = z.object({
  ...
  phone: z
    .string()
    .max(10, "El número de contacto no debe exceder los 10 caracteres")
    .optional(), //later on we will delete this line
  region: z
    .string()
    .min(5, "Localidad debe tener al menos 5 caracteres")
    .max(60, "Localidad no debe exceder los 60 caracteres")
    .optional(), //later on we will delete this line
  address: z
    .string()
  ...
  birthday: z
    .string()
    .max(12, "Fecha de nacimiento no debe exceder los 8 caracteres")
    .optional(), //later on we will delete this line
  gender: z.enum(["MALE", "FEMALE", "OTHER"], "Género no válido"),
  avatar: z.string().optional(),
  bio: z
    .string()
    .max(150, "La biografía no debe exceder los 150 caracteres")
    .optional(), //later on we will delete this line
});
